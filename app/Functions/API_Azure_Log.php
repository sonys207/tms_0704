...
class API_Azure_Log
{
    ...
    public function __construct( $api_version='2016-04-01' )
    {
     
        $this->customer_id='9872b4f2-accb-48ef-ac19-b89fef49e327'; 
        $this->shared_key='Gc5fAJst0TbKnllR32QmwiKzROCHXwR3SEEYH66HRKLYmwdlFCQu8gJ9hzrHbsLZkqp6fJlV7v1gtJtAc2G15w=='; 
    ...
    public function post_data($log_type, $json_records=array(), $record_timestamp ='')
    {
        ...
        //http request
        $context1 =file_get_contents($uri, false, $context);
